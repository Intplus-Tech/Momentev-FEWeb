...
| Method | Endpoint              | Description                            | Auth | Params / Body                                                                                                               | Source File                         |
| ------ | --------------------- | -------------------------------------- | ---- | --------------------------------------------------------------------------------------------------------------------------- | ----------------------------------- |
| `POST` | `/vendor-services`    | Create vendor service                  | ✅   | **Body:** `{ vendorId, serviceCategory, tags, minimumBookingDuration, leadTimeRequired, maximumEventSize, additionalFees }` | `lib/actions/service.ts`            |
| `POST` | `/vendor-specialties` | Create vendor specialty                | ✅   | **Body:** `{ vendorId, serviceSpecialty, priceCharge, price }`                                                              | `lib/actions/service.ts`            |
| `GET`  | `/vendor-specialties` | Get vendor specialties with pagination | ✅   | **Query:** `page`, `limit`, `vendorId?`                                                                                     | `lib/actions/vendor-specialties.ts` |
